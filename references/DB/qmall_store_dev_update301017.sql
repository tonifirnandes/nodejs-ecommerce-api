...
-- ----------------------------
BEGIN;
INSERT INTO `customer_account` VALUES ('test@gmail.com', '$2a$10$TS5sBnmvXamR9SzIipvISeUwSZaVcunn3HCdskI.fwWLhF5kMNkHW', '6282218155502');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `customer_session` VALUES ('26', 'test@gmail.com', '6282218155502', '2017-10-30 16:19:24', '2018-01-30 16:19:24', '2698694b534432a238ce5366de8149a2', 'UNBLOCK');
COMMIT;
...
-- ----------------------------
ALTER TABLE `customer_forgot_password` AUTO_INCREMENT=1;
